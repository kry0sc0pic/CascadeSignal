"""E1 -- Cascade atlas + per-episode dossiers (CAS-19).

Reproducibly builds, from the ingested data lake and CAS-16 labels:
...
Scope: Aave v2 only, matching Mock 1's stated scope (Mock 1 Notion page).
...
follow-up (CAS-44 protocol/chain expansion), not solved here -- see
