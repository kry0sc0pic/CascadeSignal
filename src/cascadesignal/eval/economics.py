"""Economic USD-protectable metric (CAS-36), the Mock 1 headline figure (E9).

"Protectable USD" accounting (CAS-36 subtask -- this is the precise
definition, pinned here rather than left implicit): an episode's
`severity_usd` (CAS-16 label field; Mock 1 = total_liquidated_usd, see
...
def usd_protectable(
    ...
    statistic over an autocorrelated time series (that's CAS-37's block
