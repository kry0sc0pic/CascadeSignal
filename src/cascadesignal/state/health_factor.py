"""Health-factor recompute:

 HF = Σ(collateral_i · price_i · liquidationThreshold_i) / Σ(debt_j · price_j)

T2 asserts every observed liquidation reconstructs to HF < 1 at its
...
def compute_health_factor(
 ...
 An optional `collateral_enabled` column (Track B
