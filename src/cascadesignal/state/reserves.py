"""Aave v2 Ethereum reserve registry.
...
# `scripts/onchain/fix_gateway_withdraw.py` to identify which ERC20
...
# Needed to pull each debt token's own `Mint`/`Burn` events for
