"""Aave v2 reserve -> Chainlink aggregator feed map (CAS-17/CAS-47).
...
as a documented approximation (ignores the WBTC/BTC peg deviation).

CAS-47 correction (2026-07-15): "zero rows in the pull" is not the same
...
`RESERVE_CHAINLINK_ETH_FEEDS` (CAS-28 H1, 2026-07-21): Aave v2's
...
#
# CAS-28 Lever 11b (2026-07-23): this list held only phase 5, and only
...
# Reserve -> native Chainlink asset/ETH feed (CAS-28 H1) -- literal output of
...
RESERVE_CHAINLINK_ETH_FEEDS: dict[str, dict] = {
    "0xdac17f958d2ee523a2206206994597c13d831ec7": {
        ...
        # Early-2021 gap (CAS-28 Lever 11, 2026-07-22): the two early phases
    ...
    "0x2260fac5e5542a773aa44fbcfedf7c193bc2c599": {
        ...
        # NOTE (CAS-28 Lever 11): Aave's real AaveOracle.AssetSourceUpdated
    ...
    "0xae7ab96520de3a18e5e111b5eaab095312d7fe84": {
        ...
        # Aave's real AaveOracle.AssetSourceUpdated history (CAS-28 Lever 11
    ...
    # GUSD/ENS/LUSD (CAS-28 Lever 11b, 2026-07-23): Aave's real oracle source
    ...
    # xSUSHI (CAS-28 Lever 11c, 2026-07-23): Aave's real oracle source
...
# LUSD/xSUSHI moved out (CAS-28 Lever 11b/11c): every one of Aave v2's 37
