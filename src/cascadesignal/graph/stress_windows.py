"""Stress-window detection for denser contagion-graph snapshots (CAS-31 subtask).
...
DEFAULT_WINDOW_BARS = 576  # ~2 days of trailing history at CAS-20's 5-block bars
...
def snapshot_blocks_with_stress(
    ...
    *,
    ...
    stepped over almost everywhere; see CAS-31 follow-up notes). This is
