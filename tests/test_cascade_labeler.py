"""Unit tests + T3 golden-label tests for the D-A cascade labeler.
...
# ---------------------------------------------------------------------------
# T3 golden-label tests — require the ingested Aave v2 data lake.
# ---------------------------------------------------------------------------
...
def test_oct25_detected_on_v3_liquidations:
 ...
 ) -- confirms the Oct 2025 gap on v2 is data availability, not a
