"""Tests for the Aave v2 interest-index oracle (CAS-47 follow-up).
...
`data/raw/aave_v2_reserve_index/` isn't present. Since CAS-28 Track D's
...
# ---------------------------------------------------------------------------
# calculate_linear_interest / calculate_compounded_interest (CAS-28 H5) --
...
# ---------------------------------------------------------------------------
# InterestIndexOracle timestamp-based compounding (CAS-28 H5), synthetic
...
def test_coverage_returns_a_single_continuous_window(oracle):
    ...
    # Track D's full-range Etherscan pull (CAS-28) closed the gaps between
