"""T1 ingestion-integrity tests: dedup, USD sanity, block-coverage
...
# Aave v2/v3 have a completed USD price join; Compound v2/v3 and Maker
# do not (out of. These are canaries, not
