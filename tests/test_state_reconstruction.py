"""Unit tests for the position-state reconstruction engine.
...
mismatch blocks the pipeline) is, a separate ticket that depends on
...
def test_position_at_log_index_sees_earlier_same_block_liquidation:
 # A same-block liquidation cascade: two LiquidationCall
...
# ---------------------------------------------------------------------------
# onBehalfOf / Withdraw correction -- Aave v2 Borrow's and Deposit's
...
# ---------------------------------------------------------------------------
# Withdraw correction -- see scripts/onchain/fix_gateway_withdraw.py
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Point-in-time liquidation thresholds (thresholds_override, Lever 3)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Collateral-toggle flag (Track B)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# aToken-transfer correction (Track C)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Interest-index accrual scaling (Track E)
# ---------------------------------------------------------------------------
...
def test_query_timestamp_compounds_index_to_the_trigger_second(tmp_path, monkeypatch):
 # / Lever 8: forward-compound the stored index using its rate,
...
def test_position_at_log_index_excludes_own_transaction_via_tx_hash(
 ...
 #: a liquidation's own internal token events
