"""Unit tests for the Hawkes branching-ratio models (: + the multivariate-by-collateral-asset slice), plus the "param recovery verified on synthetic data (T5)" acceptance check.
...
# --- T5: param recovery on synthetic data ---
