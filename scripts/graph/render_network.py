"""Contagion-graph network visualization (CAS-21 deck subtask / MVP-13 CAS-31).
...
as node-link diagrams for the Mock 1 deck: one panel from inside the Terra/LUNA
...
Output (reproducible, not hand-pasted):
  - mock2/figures/graph_network_terra.png
  - mock2/figures/graph_network_ftx.png
