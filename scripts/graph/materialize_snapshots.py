"""Full-period contagion-graph snapshot materialization .
...
**GATED ON T2.** The ticket's acceptance criterion is explicit:
...
same "measure before wiring" discipline levers used throughout
...
def main -> None:
 ...
 print(
 "\nREFUSING to materialize: acceptance criterion is "
 ...
 "artifact is PROVISIONAL -- do not treat it as "
