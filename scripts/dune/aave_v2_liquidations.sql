-- Aave v2 Ethereum LiquidationCall events with USD enrichment
-- Study period: Jan 2021 → Feb 2026 (full range, date-partition-filtered)
-- Table: aave_v2_ethereum.lendingpool_evt_liquidationcall
...
FROM aave_v2_ethereum.lendingpool_evt_liquidationcall evt
