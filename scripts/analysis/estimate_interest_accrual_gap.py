"""Quantify how much of 's HF-at-trigger mismatch is plausibly
...
than that window-relative measurement could see. Hand-tracing a "typical" account's real
...
variable-debt growth at all. (`scripts/onchain/backfill_reserve_index.py`) pulled the full
