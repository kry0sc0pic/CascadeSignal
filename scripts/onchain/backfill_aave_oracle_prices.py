...
the reserves Chainlink log reconstruction cannot price at all.
...
already gets right, the live oracle agrees to a median 0.22% price difference -- repricing all ~29.4k trigger blocks would cost ~100k archive
